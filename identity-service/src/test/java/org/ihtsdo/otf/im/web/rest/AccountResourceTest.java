...
public class AccountResourceTest {
	...
	public void setup() {
		...
		doNothing().when(mockMailService).sendActivationEmail((IHTSDOUser) anyObject(), anyString());
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        IHTSDOToolsAuthority authority = new IHTSDOToolsAuthority(AuthoritiesConstants.IHTDO_OPS_ADMIN);
        authorities.add(authority);

        //when(mockUserService.getUserWithAuthorities()).thenReturn(IHTSDOUser.getInstance(auth));
        ...
        restUserMockMvc.perform(get("/api/account")
                ...
                .andExpect(jsonPath("$.roles").value(AuthoritiesConstants.IHTDO_OPS_ADMIN));
    }
    ...
    public void testRegisterValid() throws Exception {
        ...
        IHTSDOUser user = userRepository.getUserByUserName("joe");
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        IHTSDOUser user = userRepository.getUserByUserName("johnjr");
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        UserDTO u = new UserDTO(
            ...
            "en",                   // langKey
            Arrays.asList(AuthoritiesConstants.IHTDO_OPS_ADMIN) // <-- only admin should be able to do that
        );
        ...
        IHTSDOUser userDup = userRepository.getUserByUserName("johnjr");
