...
class AuthControllerTest extends IntegrationTest {
    ...
    void login_ShouldRedirectToKeycloak_WhenValidRequest() {
        ...
        String expectedAuthUrl = "http://keycloak:8080/realms/test/protocol/openid-connect/auth?client_id=test-client&redirect_uri=http://localhost:8080/identity-management-service/api/auth/callback&response_type=code&scope=openid%20profile%20email&state=%2Fdashboard";
